...
- **The postmortems under `docs/`** (sixteen of them — boot bring-up; shell
  ...
  and a sentinel collision `rustc` flagged); and dial-out (the `/net/tcp`
