...
Ten-crate workspace (`kernel`, `shell`, `hello`, `pong`, `fsd`,
`upper`, `cond`, `netd`, `args`, `syscall-abi`), with every userland crate deliberately excluded from the
