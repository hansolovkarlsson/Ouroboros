...
- **The postmortems under `docs/`** (twelve of them — boot bring-up; shell
  ...
  and the distributed cluster arc (Phases 1–3: 9P-over-TCP, two-node
  read/write disk sharing, and resources-as-files /proc·/dev/cons·/net —
  the day Ouroboros went distributed, v0.6.0–v0.8.0))
