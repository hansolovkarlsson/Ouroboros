...
| [2026-09-12](2026-09-12.md) | 4 | fid-verbs step 5, the export half, built and then hardened by two reviews · the `fsd`-side change, one mechanism for two leaks · step 6, `NP_PREAD`, and the fold that came with it · the client half of step 5, the held client session (Decision 4) |
