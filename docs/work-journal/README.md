...
| [2026-09-23](2026-09-23.md) | 3 | the async arc gets its postmortem, the thirtieth: a blocking call is a lock nobody wrote down · X25519, and a stack gate that failed at the park (80 bytes), so a park never signs · the delegation race closed in libc, and a pass count sized to a rare control |
